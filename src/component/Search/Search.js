...
export default function Search() {
  ...
  //   try {
  //     const filteredBuses = await busSearchService.fetchFilteredBuses(
  //       from,
  //       to,
  //       showACBus,
  //       showNonACBus,
  ...
  //       maxPrice
  //     );
  //     filteredSearch=filteredBuses;
  //   } catch (error) {
  //     console.error("Error searching for buses:", error);
  //     toast.error("Failed to search for buses");
  //   }
  // }
  // handleSearch();
  // console.log(filteredSearch,"hello");
        ...
        <div className="filterContent">
          ...
          <label>
            <InputField
              type="number"
              value={minPrice}
              onChange={(e) => setMinPrice(e.target.value)}api
            />
            Min Price:{" "}
          </label>
          <br />
